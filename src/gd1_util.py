...
def predict_gd1obs(
    ...
    if not success:
        return (numpy.zeros((1001, 6)) - 1000000.0, False)
        # Try again with TM
        this_useTM = True
...
def gd1_lnlike(posdata, distdata, pmdata, rvdata, track_phi):
    ...
    """
    out = numpy.zeros(5) - 1000000000000000.0
...
def setup_sdf(
    ...
    if False:
        # Determine good one
        ts = numpy.linspace(0.0, 15.0, 1001)
        # Hack!
