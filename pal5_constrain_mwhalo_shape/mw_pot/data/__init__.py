...
def _binlbins(glon: float, vterm: float, dl: float = 1.0) -> Tuple[Sequence, Sequence]:
    """Bin l bins."""
    minglon, maxglon = (
...
def readMcClureGriffiths07(dsinl: float = 0.5 / 8.0, bin: bool = True) -> TermVelTuple:
...
def readMcClureGriffiths16(dsinl: float = 0.5 / 8.0, bin: bool = True) -> TermVelTuple:
...
def readallMcClureGriffiths(dsinl: float = 0.5 / 8.0, bin: bool = True) -> Tuple:
